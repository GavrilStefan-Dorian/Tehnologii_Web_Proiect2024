...
function createGroupCard(cardData) {
  ...
  card.innerHTML = `
    <img src="../Resources/Images/${cardData.imageSrc}" alt="${cardData.title}">
...
function selectGroup(cardData) {
  ...
  window.location.href = `group-page.html?group=${groupName}&img=../Resources/Images/${imageSrc}&desc=${desc}`;
}
